...
namespace WordTests
{
    class Program
    {
        ...
        const string Appreciation_Note_to_a_Team_Member = "{\"Template\": \"<p  align=''left'' style=''font-size:20px; color:green;''><b>Appreciation Note to a Team Member </br> <b> Date: </b>$Date <b> Dear: </b>$Name </p><p align=''left'' style=''font-size:20px; color:black; ''>I really appreciate your taking the time to help us get started on our year-end inventory.</br> It was so helpful to have someone who has been through the whole process before to guide the newer employees through the procedure.</br> Your experience made everything go so much smoother, and we are already noting improved accuracy in our numbers due to your input.</br> </p><p align =''left'' style=''font-size:20px; color:orange;''><b>regards,</br></b>$From </p>\", \"numberOfChanges\": 3}";
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //CreateAdminUsers();
                //CreateTopics();
                string jsonValue = Appreciation_Note_to_a_Team_Member;
                AppEngineBuilder.GetAppEngine().CreateNewTemplate(jsonValue, "Appreciation Note to a Team Member", "shani", "Thank-You");
